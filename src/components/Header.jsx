...
const Header = ({ setViewPort }) => {
    ...
    return (
        <div className='px-10 z-50 h-16 grid grid-cols-2 sticky flex flex-row top-0 bg-slate-900 text-slate-50'>
          ...
          ${isDarkMode ? 'jus tify-start bg-gray-300' : 'justify-end bg-gradient-to-r from-blue-100 to-yellow-200'}`}
                >
