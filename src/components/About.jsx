      ...
      <div className="pb-16">
        <div className="flex justify-center">
          <motion.div
            ...
            <div className='div4 p-6 rounded-lg m-6 bg-slate-700 bg-opacity-50 grid items-center text-slate-50'><p className='indent-8'>I thrive on working closely with clients to understand their vision and goals. Your dreams, combined with my technical expertise, will pave the way for digital masterpieces.</p></div>
